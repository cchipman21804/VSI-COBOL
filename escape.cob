      ...
      *                       Future features:
      *
      * Add text labels in debugging lines for "Robot moves:" and
      * "TELEPORTING TO:"
      *
