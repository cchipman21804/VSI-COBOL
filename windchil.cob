      ...
      * Display fields.
       ...
       130-wind-speed-data-entry.
           display "Enter wind speed in MPH " with no advancing
           display "(nnn.n): " with no advancing
           accept wind-speed-in
           move function LOWER-CASE (wind-speed-in)
                 TO wind-speed-in

           if wind-speed-in IS EQUAL TO "zero"
            then go to 999-end-program 
           else
              compute wind-speed =
           ...
           if wind-speed IS EQUAL TO ZERO then
              go to 999-end-program
           end-if
           ...
           if wind-speed > max-wind
              ...
              display spaces
              go to 130-wind-speed-data-entry
           end-if
