      ...
      * from the TRANE Psychrometric Chart Form Number 1-43.190 Jan.1983
       ...
       120-init-specific-humidity-tbl.
       ...
       140-rel-humidity-data-entry.
           display "Enter relative humidity as %: " with no advancing
           accept rh-in
           move function LOWER-CASE (rh-in) to rh-in

           if rh-in IS EQUAL TO "zero"
            then go to 999-end-program
           else
           ...
           if relative-humidity > 100
              display quantity-too-much
              display spaces
              go to 140-rel-humidity-data-entry
           end-if
